<?php
/* Smarty version 3.1.30, created on 2020-09-20 20:34:04
  from "D:\phpStudy\PHPTutorial\WWW\kaoshi\admin\template\edit_exam.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5f674c3c87e969_97605577',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '63c89bc53ae7d76d9c3cc4d44f72024189402de0' => 
    array (
      0 => 'D:\\phpStudy\\PHPTutorial\\WWW\\kaoshi\\admin\\template\\edit_exam.html',
      1 => 1600157421,
      2 => 'file',
    ),
  ),
...
function content_5f674c3c87e969_97605577 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:admin_header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('title'=>"修改试卷-考试系统"), 0, false);
?>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form class="form-horizontal" id="editexam" style="margin-top:40px;">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" type="text" id="title" equ="title" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['title'];?>
" needle="needle" datatype="title" msg="请输入学校" name="title"/>
...
" <?php if ($_smarty_tpl->tpl_vars['row']->value['id'] == $_smarty_tpl->tpl_vars['v']->value['id']) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['school'];?>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name='status' id="status" class="form-control" style="margin-top: 10px;">
									<option value="0">请选择</option>
									<option value="1" <?php if ($_smarty_tpl->tpl_vars['row']->value['status'] == 1) {?> selected="selected" <?php }?>>启用</option>
									<option value="2" <?php if ($_smarty_tpl->tpl_vars['row']->value['status'] == 2) {?> selected="selected" <?php }?>>停用</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" type="number" id="pass_line" equ="pass_line" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['pass_line'];?>
" needle="pass_line" datatype="pass_line" msg="请输入及格线" name="pass_line"/>
